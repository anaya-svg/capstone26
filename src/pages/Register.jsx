    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 dark:from-slate-900 dark:to-slate-800 flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 items-center justify-center p-8">
        <div className="text-center">
          ...
          />
          <h2 className="text-3xl font-bold text-gray-800 dark:text-white mb-2">Join SnapFun</h2>
          <p className="text-gray-600 dark:text-gray-400 text-lg">Start managing your photo studio today</p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500">Register to start managing your photo studio</p>
          </div>
