    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 dark:from-slate-900 dark:to-slate-800 flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 items-center justify-center p-8">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 text-lg">Manage your studio resources</p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            <h1 className="text-2xl font-bold text-gray-800 dark:text-white mb-2">Administrator Login</h1>
            <p className="text-gray-500 dark:text-gray-400">Sign in to your admin account to continue</p>
          </div>
          ...
          <div className="text-center mt-6">
            <p className="text-gray-600">
              ...
              <Link to="/admin-register" className="text-blue-600 font-medium hover:text-blue-700">
                Register here
              </Link>
            </p>
          </div>
